# T³ - TOE - Domains Manager

This branch (*release-trigger-revision*) is a [**release trigger branch**](#release-trigger-branch) for the **T³ - TOE - Domains Manager** project.
...
To trigger a new release with *revision* increment policy, simply [run a new pipeline](https://git.teecu.be/teecube/toe-domains/pipelines/new) after selecting *release-trigger-revision* in the list.
That's it !
...
These versions numbers can also be [edited directly in Gitlab](https://git.teecu.be/teecube/toe-domains/edit/release-trigger-revision/release.properties).
